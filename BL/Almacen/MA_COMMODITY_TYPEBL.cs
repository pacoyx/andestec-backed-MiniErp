...
namespace BL.Almacen
{
    ...
    {
        public void Registrar(EMA_COMMODITY_TYPE ee) { if (MA_COMMODITY_TYPEDA.GetByid(ee) == null) { MA_COMMODITY_TYPEDA.Insert(ee); } else { MA_COMMODITY_TYPEDA.Update(ee); } }
        public void Eliminar(EMA_COMMODITY_TYPE ee) { MA_COMMODITY_TYPEDA.Delete(ee); }
