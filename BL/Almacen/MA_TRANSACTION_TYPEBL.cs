...
namespace BL.Almacen
{
    ...
    {
        public string Registrar(EMA_TRANSACTION_TYPE ee) { if (MA_TRANSACTION_TYPEDA.GetByid(ee) == null) {return MA_TRANSACTION_TYPEDA.Insert(ee); } else { return MA_TRANSACTION_TYPEDA.Update(ee); } }
        public string Eliminar(EMA_TRANSACTION_TYPE ee) { return MA_TRANSACTION_TYPEDA.Delete(ee); }
